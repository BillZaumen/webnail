var controlStrings1 = [
 ...
 ' onclick="syncIndex(); index--; while (index &lt; 0) index++; updateLocations(\'.\');">',
 '</TD>',
 '<TD align="center">',
 '<A id="expand" href="controls/initImage.png" target="_blank"><IMG src="controls/expand.png" onclick="syncIndex(); updateExpand(); true"></A>',
 '</TD>',
 '<TD align="center">',
 '<INPUT TYPE="image" SRC="controls/right.gif" id="right"',
 ' onclick="syncIndex(); index++; if (index &gt; imageArray.length - 1) index--; updateLocations(\'.\');">',
 '</TD>',
 '<TD align="center">',
 ...
 ' onclick="syncIndex(); controlSlideshow();">',
 '</TD>'
 ];
