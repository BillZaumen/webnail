...
public class Gui {
	...
	*/
	JMenuItem portMenuItem = new
	    VTextFieldMenuItem(portTextField, localeString("httpPort"),
			       frame, localeString("httpPortTitle"),
			       localeString("enterPort"), true);
	...
	*/
	...
	JMenuItem pwordMenuItem = new
	    VTextFieldMenuItem(pwTextField, localeString("password"),
			       frame, localeString("password"),
			       localeString("password") + ":", true);
